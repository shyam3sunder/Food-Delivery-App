...
const FoodItem = ({name,description,id,imageUrl,price}) => {
    ...
    return (
        <div className="col-12 col-sm-6 col-md-4 col-lg-3 mb-4 d-flex justify-content-center">
            ...
            <div className="card w-100 h-100 shadow" style={{ "maxWidth": "320px"}}>
            <Link to={`/food/${id}`}>   <img src={imageUrl} className="card-img-top" alt="Product Image" height={300} width={60}/>
            </Link>
