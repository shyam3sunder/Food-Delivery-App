...
const Menubar = () => {
  ...
  return (
    <nav className="navbar navbar-expand-lg bg-secondary-subtle bg-body-tertiary nav">
      <div className="container">
        <Link to={"/"}>  <img src={assets.logo1} alt="" className='mx-2' height={48} width={48} />
        </Link>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div className="d-flex align-items-center gap-4">
            ...
            <div className="position-relative">
              <img src={assets.cart} alt="" className="position-relative" height={28} width={28} />
